...
export default {
  CHAT_PROMPT: dedent`
  'You are a AI Assistant and experienced in Web Development.
  GUIDELINES:
  - Refuse to answer any questions that are not related to Web Development.
...
files:{
  ...
  But remember you are already working withing the src/ folder of the project so you are not to include that in your response.
