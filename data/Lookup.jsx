...
export default {
  SUGGSTIONS: ['Create React ToDo App', 'Create React Budget Track App', 'Create React Gym Managment Portal Dashboard', 'Create React Quizz App On History', 'Create React Login Signup Screen'],
